...
const Terms: React.FC = () => (
    <Layout>
        <div className="mb-10 px-5 mx-auto article max-w-3xl">
            <h1>Inquest Terms of Service</h1>
            <h3>1. Terms</h3>
            <p>
                By accessing the website at{" "}
                <a href="https://inquest.dev">https://inquest.dev</a>, you are
            ...
            <ol type="a">
                <li>
                    ...
                    the materials (information or software) on Inquest's website
                    ...
                    <ol type="i">
                        ...
                        <li>
                            ...
                            software contained on Inquest's website;
                        </li>
                        <li>
                ...
                <li>
                    ...
                    any of these restrictions and may be terminated by Inquest
            ...
            <ol type="a">
                <li>
                    The materials on Inquest's website are provided on an 'as
                    is' basis. Inquest makes no warranties, expressed or
                ...
                <li>
                    Further, Inquest does not warrant or make any
            ...
            <h3>4. Limitations</h3>
            <p>
                In no event shall Inquest or its suppliers be liable for any
                damages (including, without limitation, damages for loss of data
                or profit, or due to business interruption) arising out of the
                use or inability to use the materials on Inquest's website, even
                if Inquest or a Inquest authorized representative has been
            ...
            <p>
                The materials appearing on Inquest's website could include
                technical, typographical, or photographic errors. Inquest does
                not warrant that any of the materials on its website are
                accurate, complete or current. Inquest may make changes to the
                materials contained on its website at any time without notice.
                However Inquest does not make any commitment to update the
                materials.
            </p>
            <h3>6. Links</h3>
            <p>
                Inquest has not reviewed all of the sites linked to its website
                and is not responsible for the contents of any such linked site.
                The inclusion of any link does not imply endorsement by Inquest
                of the site. Use of any such linked website is at the user's own
                risk.
            </p>
            <h3>7. Modifications</h3>
            <p>
                Inquest may revise these terms of service for its website at any
